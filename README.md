...
This repository is a project of **Visual Studio 2022**. To open this project in **VS**, just double click on the project file `My_Minesweeper.sln`.
...
- `src/`:
  Contains source codes of the program.

- `VSproject/`:
  Contains project files of **VS**.
