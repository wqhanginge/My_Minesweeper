...
//StringTable is 000004b0 (Language Neutral)
...
//Aggregate of UI runtime status, related to several visual features.
typedef struct _UIRuntime {
    BOOL qmark;         //QuestionMark feature
    ...
    bool mu_skip;       //if MapUnit event should be skipped
    bool mu_area;       //if multiple MapUnits are selected
...
//The input should be the LPARAM of WM_MOUSEMOVE message or something
//equivalent that can be unpacked using MAKEPOINTS macro.
