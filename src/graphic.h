 ...
 * have edges. Object is atomic and usually does not have edges.
 ...
 * their positions when GameMode changes.
 *
 ...
 * Relevantly, we call the INums in Mine Region and Time Region as MNums and
 * TNums, respectively.
 *
...
#define UICOL_CLIENT    RGB(240,240,240)
...
#define INUMSF_HIDEALL  0x00
#define INUMSF_SHOWA    0x01
#define INUMSF_SHOWB    0x02
#define INUMSF_SHOWC    0x04
#define INUMSF_SHOWALL  0x07
...
#define ICOL_SURFACE    UICOL_CLIENT
...
#define RBCOL_SURFACE   UICOL_CLIENT
...
#define MUCOL_BARESF    UICOL_CLIENT
...
#define HACOL_SURFACE       UICOL_CLIENT
...
#define MACOL_SURFACE       UICOL_CLIENT
...
#define CLTCOL_SURFACE      UICOL_CLIENT
//end Client Area
...
//Accept numbers within [INFONUM_MIN, INFONUM_MAX], or INFONUM_DASH
//for symbol '-', otherwise, draws a blank 7-segment display.
...
//The drawing behavior is controlled by 'flag', which is a
//combination of INUMSF* flags that controls whether a InfoNum
//turns on.
